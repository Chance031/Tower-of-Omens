...
// 콘솔 렌더러를 기본 상태로 초기화한다.
ConsoleRenderer::ConsoleRenderer()
    : m_impl(std::make_unique<Impl>())
{
}

// 소멸자에서 변경된 콘솔 상태를 원상복구한다.
ConsoleRenderer::~ConsoleRenderer()
{
    Shutdown();
}

// ANSI 가상 터미널 처리를 사용할 수 있도록 콘솔을 초기화한다.
